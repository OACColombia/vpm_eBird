...
Fig1b <- ggplot() +
  ...
  labs(y = "Latitude",
       ...
       title = "Snail Kite in Payne's Prairie",
       subtitle = "eBird records") +
...
ggsave("results/Fig1_SnailKitesMap.pdf", 
       plot = Fig1, dpi = 300, width = 11, height = 5, units = "in")
...
snailkites.paynesp <- snailkites.paynesp |>
  left_join(snail.kite.project.pp)

plot(snailkites.paynesp$Time.t, 
     snailkites.paynesp$Observed.y,
     type = "b", cex.lab=1.25, col = "blue", pch = 1,
     ylim=c(0,300),
     ylab = "Population abundance",
     xlab = "Observation date (weeks)")
points(snailkites.paynesp$Time.t, 
     snailkites.paynesp$abundance.monitored,
     type = "b", col = "black", pch = 19)
legend("topleft", legend=c("Observed eBird", "Standardized Monitored"),
       col=c("blue", "black"), lty=c(1,1), pch = c(1,19), cex=0.8)
...
#add critical value line
abline(h=N.critical, lty=2, lwd=1, col = "#FF000098")	
