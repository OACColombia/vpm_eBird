...
FigS3a <-
  ggplot(data = sk.Estimated_figA, aes(x = observation.date, 
             y = Abundance))+
...
FigS3b <- ggplot(sk.Estimated)+
  ...
  geom_smooth(aes(x=abundance.monitored, y=Estimated_SKProj_EGSS),
              ...
              se = F, fill = "#fc8d5905", linetype = "solid")+
  geom_line(aes(x=abundance.monitored, y=Estimated_SKProj_EGSS), 
             color = "#FE996B", linetype = "dashed", size = 1)+
...
#            parse = TRUE, color = "#fc8d59")+
  geom_smooth(aes(x=abundance.monitored, y=Estimated_eBird_EGSS),
              ...
              se = F, fill = "#91bfdb05", linetype = "solid")+
  geom_line(aes(x=abundance.monitored, y=Estimated_eBird_EGSS), 
             color = "#4575b4", linetype = "dashed", size = 1)+
...
ggsave("results/Figure3ab_EstimatedTrajectory2initdays.pdf", 
       plot = FigS3, dpi = 300, width = 10, height = 4.2, units = "in")
...
ggsave("results/Figure5_sensitivity_datareductionx2.pdf", 
       plot = Fig5All, dpi = 300, width = 12, height = 15, units = "in")
